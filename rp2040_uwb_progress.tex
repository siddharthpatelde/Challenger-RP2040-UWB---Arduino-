...
\footnote{DW3000 User Manual (Decawave/Qorvo), section ``Single-sided two-way ranging'':
	...
	\begin{figure}[H]
		...
		\includegraphics[width=0.95\linewidth]{figures/ss_twr_timing.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\linewidth]{figures/TdoA.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\linewidth]{figures/2d_geo.pdf}
